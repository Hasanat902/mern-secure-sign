const About = () => {
  return (
    <div className="px-4 py-12 max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold  mb-4 text-blue-400">About us!</h1>
      <div className="border border-gray-300 rounded-lg p-4 bg-gray-200 shadow-lg">
        <p className="mb-4 text-slate-600">
          This is a full-stack authentication web application built with the
          MERN (MongoDB, Express, React, Node.js) stack. It includes
